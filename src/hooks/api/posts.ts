...
export const useGetPageBlogPostAdmin = ({
    paginationState,
}: {
...
export const useCreateBlogPost = () => {
    ...
    return useMutation({
        mutationFn: (variables: z.infer<typeof apiData.admin.create.type>) =>
            customeFetcher({
                method: "POST",
        ...
        onSuccess: async (data) => {
            if (data?.success) {
                ...
                await queryClient.invalidateQueries({
                    queryKey: [apiData.admin.getPage.url],
                });
            }
        },
    });
...
export const useDeleteBlogPost = (slug: string) => {
    ...
    return useMutation({
        mutationFn: (variables: z.infer<typeof apiData.admin.delete.type>) =>
            customeFetcher({
