...
function CoachList({items}: { items: Coach[] }) {
    return (
        <>
            {items.map((coach: Coach) => <>
                <Col span={6}>
                    <div
                        className="focus:outline-none lg:mr-7 mb-7 bg-white p-6 shadow rounded">
                        <div className="flex items-center border-b border-gray-200 pb-6">
                            ...
                            <div className="flex items-start justify-between w-full">
                                <div className="pl-3 w-full">
                                    <p
                                        className="focutabIndexe-none text-xl font-medium leading-5 text-gray-800">
                                        {coach.name}
                                    </p>
                                    <p
